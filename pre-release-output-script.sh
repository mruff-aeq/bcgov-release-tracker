...
# ensure_clone in pre-release-watch.sh). bcgov/lear is big and used by SIX
...
echo "    <ul>"
echo "      <li>$(curl -fsSL https://raw.githubusercontent.com/bcgov/lear/refs/heads/main/legal-api/pyproject.toml | grep -E '^version' | grep -oE '[0-9]+\.[0-9]+\.[0-9]+')</li>"
echo "    </ul>"
echo "  </li>"
